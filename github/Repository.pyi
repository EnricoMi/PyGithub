...
class Repository(CompletableGithubObject):
    ...
    def get_artifact(self, artifact_id: int, lazy: bool = ...) -> Artifact: ...
    ...
    def get_branch(self, branch: str, lazy: bool = ...) -> Branch: ...
    def rename_branch(self, branch: Union[str, Branch], new_name: str) -> bool: ...
    def get_branches(self) -> PaginatedList[Branch]: ...
    def get_check_run(self, check_run_id: int, lazy: bool = ...) -> CheckRun: ...
    def get_check_suite(self, check_suite_id: int, lazy: bool = ...) -> CheckSuite: ...
    ...
    def get_comment(self, id: int, lazy: bool = ...) -> CommitComment: ...
    def get_comments(self) -> PaginatedList[CommitComment]: ...
    def get_commit(self, sha: str, lazy: bool = ...) -> Commit: ...
    def get_commits(
        self,
    ...
    def get_deployment(self, id_: int, lazy: bool = ...) -> Deployment: ...
    def get_deployments(
        self,
        sha: Union[str, _NotSetType] = ...,
    ...
    def get_download(self, id: int, lazy: bool = ...) -> Download: ...
    ...
    def get_git_blob(self, sha: str, lazy: bool = ...) -> GitBlob: ...
    def get_git_commit(self, sha: str, lazy: bool = ...) -> GitCommit: ...
    def get_git_matching_refs(self, ref: str) -> PaginatedList[GitRef]: ...
    def get_git_ref(self, ref: str, lazy: bool = ...) -> GitRef: ...
    def get_git_refs(self) -> PaginatedList[GitRef]: ...
    def get_git_tag(self, sha: str, lazy: bool = ...) -> GitTag: ...
    def get_git_tree(self, sha: str, recursive: Union[bool, _NotSetType] = ...) -> GitTree: ...
    def get_hook(self, id: int, lazy: bool = ...) -> Hook: ...
    ...
    def get_issue(self, number: int, lazy: bool = ...) -> Issue: ...
    def get_issues(
        self,
    ...
    def get_pull(self, number: int, lazy: bool = ...) -> PullRequest: ...
    def get_pulls(
        self,
        state: Union[str, _NotSetType] = ...,
        sort: Union[str, _NotSetType] = ...,
    ...
    def get_release(self, id: Union[int, str], lazy: bool = ...) -> GitRelease: ...
    def get_release_asset(self, id: int, lazy: bool = ...) -> GitReleaseAsset: ...
    ...
    def get_workflow(self, id_or_name: Union[str, int], lazy: bool = ...) -> Workflow: ...
    def get_workflows(self) -> PaginatedList[Workflow]: ...
    def get_workflow_run(self, id_: int, lazy: bool = ...) -> WorkflowRun: ...
