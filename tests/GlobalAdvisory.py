...
class GlobalAdvisory(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertIsNone(self.advisory.documentation_url)
        self.assertIsNone(self.advisory.epss)
        ...
        self.assertIsNone(self.advisory.message)
        ...
        self.assertIsNone(self.advisory.status)
        self.assertEqual(
